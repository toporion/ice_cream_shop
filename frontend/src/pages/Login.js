...
import { Mail, Lock, ArrowRight, LogIn, Eye, EyeOff, Heart, Chrome, Facebook } from 'lucide-react';
...
const Login = () => {
    ...
    const onSubmit = async (data) => {
        ...
        alert("Sweet! You're in. 🍩");
    };

    return (
        <div className="relative w-full h-[100dvh] bg-[#1a0b2e] overflow-hidden flex flex-col items-center justify-center font-sans text-white selection:bg-pink-500 selection:text-white">
            ...
            <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-none z-0">
                ...
                >
                    {/* Layer 1: Deep Purple/Pink Shadow */}
                    <path 
                        d="M0,0V46.29c47.79,22.2,103.59,32.17,158,28,70.36-5.37,136.33-33.31,206.8-37.5C438.64,32.43,512.34,53.67,583,72.05c69.27,18,138.3,24.88,209.4,13.08,36.15-6,69.85-17.84,104.45-29.34C989.49,25,1113-14.29,1200,52.47V120H0Z" 
                        className="fill-pink-900/40" 
                    ></path>
                    
                    {/* Layer 2: Bright Pink Accent */}
                    <path 
                        d="M0,0V15.81C13,36.92,27.64,56.86,47.69,72.05,99.41,111.27,165,111,224.58,91.58c31.15-10.15,60.09-26.07,89.67-39.8,40.92-19,84.73-46,130.83-49.67,36.26-2.85,70.9,9.42,98.6,31.56,31.77,25.39,62.32,62,103.63,73,40.44,10.79,81.35-6.69,119.13-24.28s75.16-39,116.92-43.05c59.73-5.85,113.28,22.88,168.9,38.84,30.2,8.66,59,6.17,87.09-7.5,22.43-10.89,48-26.93,60.65-49.24V120H0Z" 
                        className="fill-pink-600/30"
                    ></path>
                    
                    {/* Layer 3: Cyan/Purple Foreground Wave */}
                    <path 
                        ...
                        className="fill-[#2a1b3d]" // Slightly lighter than bg to stand out
                    ></path>
                </svg>
            </div>

            {/* --- 2. GLASS CARD (The "Candy Box") --- */}
            <div className="relative z-10 w-full max-w-sm md:max-w-md bg-white/5 backdrop-blur-xl border border-white/10 shadow-[0_8px_32px_0_rgba(0,0,0,0.37)] p-8 md:rounded-[2.5rem] flex flex-col gap-6 overflow-hidden mb-10">
                ...
                <div className="text-center space-y-2 mt-4 md:mt-0">
                    ...
                    <p className="text-white/60 text-sm font-medium">
                        Craving something sweet? Log in now!
                    </p>
                </div>
