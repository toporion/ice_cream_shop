            ...
            */}
            <nav className={`fixed left-0 right-0 z-50 transition-all duration-300 ease-in-out ${
                ...
                <div className={`mx-auto max-w-7xl transition-all duration-300 ${
                    isScrolled ? 'px-4' : 'px-4 md:px-8'
                }`}>
                    
                    {/* Main Container - The "Pill" Shape */}
                    <div className={`relative flex items-center justify-between px-6 py-3 transition-all duration-300 border shadow-xl backdrop-blur-md ${
                        isScrolled 
            ...
            <div className={`fixed inset-0 z-40 bg-white/95 backdrop-blur-xl transition-transform duration-300 md:hidden flex flex-col items-center justify-center space-y-8 ${
